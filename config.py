...
# Bot
BOT_TOKEN = os.getenv("BOT_TOKEN", "8644394082:AAEAa0xJWR9Sva0seVVoFVMr8FEeGhUcd18")
BOT_USERNAME = os.getenv("BOT_USERNAME", "ghost_vpn_bot")
...
PARTNER_PERCENT = int(os.getenv("PARTNER_PERCENT", "30"))
PARTNER_MIN_WITHDRAWAL = int(os.getenv("PARTNER_MIN_WITHDRAWAL", "2000"))
